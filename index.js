	...
	(function (global, factory) {
	    ...
	    ***************************************************************************** */
	    ...
	    emojiData.emoji.forEach(function (emoji) {
	        var categoryList = emojiCategories[categories[emoji.category]];
	        if (!categoryList) {
	    ...
	    var Tabs = /** @class */ (function () {
	        ...
	        Tabs.prototype.createTabs = function () {
	            ...
	            this.tabs = (this.options.categories || []).map(function (category, index) {
	        ...
	        Tabs.prototype.createTabBodies = function () {
	            ...
	            this.tabBodies = (this.options.categories || []).map(function (category, index) {
	    ...
	    var EmojiButton = /** @class */ (function () {
	        ...
	        EmojiButton.prototype.buildPicker = function () {
	            ...
	            if (this.options.showSearch) {
	                var searchContainer = new Search(this.events, this.i18n, this.options, emojiData.emoji, this.options.autoFocusSearch || true).render();

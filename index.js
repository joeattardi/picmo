	...
	(function (global, factory) {
	    ...
	    ***************************************************************************** */
	    ...
	    function save(emoji, options) {
	        ...
	        localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify(__spreadArrays([recent], recents.filter(function (r) { return r.k !== recent.k; })).slice(0, options.recentsCount)));
	    }
	    ...
	    var Search = /** @class */ (function () {
	        function Search(events, i18n, options, emojiData, autoFocusSearch) {
	            ...
	            this.options = options;
	            this.emojiData = emojiData.filter(function (e) { return parseFloat(e.ver) <= parseFloat(options.emojiVersion); });
	            this.autoFocusSearch = autoFocusSearch;
	    ...
	    var emojiCategories = {};
	    emojiData.emojiData.forEach(function (emoji) {
	    ...
	    var Tab = /** @class */ (function () {
	        ...
	        Tab.prototype.render = function () {
	            ...
	            this.tab.addEventListener('click', function () { return _this.setActiveTab(_this.index); });
	            return this.tab;
	        };
	    ...
	    var TabBody = /** @class */ (function () {
	        ...
	        TabBody.prototype.setActive = function (active) {
	            if (active) {
	    ...
	    var Tabs = /** @class */ (function () {
	        ...
	        Tabs.prototype.setActiveTab = function (index, animate) {
	            ...
	            if (currentActiveTab >= 0) {
	                ...
	                currentActiveTabBody
	                    ...
	                    .forEach(function (emoji) { return (emoji.tabIndex = -1); });
	        ...
	        Tabs.prototype.transitionTabs = function (newActiveTabBody, currentActiveTabBody, newTranslate, currentTranslate) {
	        ...
	        Tabs.prototype.setFocusedEmoji = function (index) {
	        ...
	        Tabs.prototype.createTabBodies = function () {
	            ...
	            this.tabBodyContainer.addEventListener('keydown', function (event) {
	                var emojis = _this.tabBodies[_this.activeTab].content.querySelectorAll('.emoji-picker__emoji');
	                if (event.key === 'ArrowRight') {
	                    _this.setFocusedEmoji(Math.min(_this.focusedEmojiIndex + 1, emojis.length - 1));
	                }
	                else if (event.key === 'ArrowLeft') {
	                    _this.setFocusedEmoji(Math.max(0, _this.focusedEmojiIndex - 1));
	                }
	                else if (event.key === 'ArrowDown') {
	                    event.preventDefault();
	                    if (_this.focusedEmojiIndex < emojis.length - EMOJIS_PER_ROW$1) {
	                        _this.setFocusedEmoji(_this.focusedEmojiIndex + EMOJIS_PER_ROW$1);
	                    }
	                }
	                else if (event.key === 'ArrowUp') {
	                    event.preventDefault();
	                    if (_this.focusedEmojiIndex >= EMOJIS_PER_ROW$1) {
	                        _this.setFocusedEmoji(_this.focusedEmojiIndex - EMOJIS_PER_ROW$1);
	                    }
	                }
	            });
	            ...
	            this.events.on(EMOJI, function (_a) {
	                ...
	                if (button.parentElement &&
	                    ...
	                    _this.setFocusedEmoji(Array.prototype.indexOf.call(button.parentElement.children, button));
	                }
	                else {
	                    _this.setFocusedEmoji(_this.focusedEmojiIndex);
	                }
	            });
	            if (this.options.showRecents) {
	                ...
	                this.events.on(EMOJI, function () {
	                    var newRecents = new TabBody(_this.i18n.categories.recents || i18n.categories.recents, new EmojiContainer(load(), false, _this.events, _this.options).render(), 0);
	                    var newRecentsEl = newRecents.render();
	                    if (_this.activeTab === 0) {
	                        newRecentsEl.style.transform = 'translateX(0)';
	                    }
	                    setTimeout(function () {
	                        _this.tabBodyContainer.replaceChild(newRecentsEl, _this.tabBodyContainer
	                            .firstChild);
	                        _this.tabBodies[0] = newRecents;
	                        if (_this.activeTab === 0) {
	            ...
	            this.tabBodies.forEach(function (tabBody) {
	                return _this.tabBodyContainer.appendChild(tabBody.render());
	            });
	    ...
	    var EmojiButton = /** @class */ (function () {
	        ...
	        EmojiButton.prototype.buildPicker = function () {
	            ...
	            if (this.options.showSearch) {
	                var searchContainer = new Search(this.events, this.i18n, this.options, emojiData.emojiData, this.options.autoFocusSearch || true).render();
